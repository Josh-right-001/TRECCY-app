        ...
        <div className="space-y-6">
          ...
          <div className="flex gap-4 justify-end">
            <button
              ...
              className="px-6 py-3 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 border-2 border-gray-300 dark:border-gray-600 rounded-xl hover:border-cyan-500 dark:hover:border-cyan-400 hover:text-cyan-600 dark:hover:text-cyan-400 transition-all duration-200 font-medium flex items-center gap-2"
            >
            ...
            <button
              ...
              className="px-8 py-3 bg-gradient-to-r from-cyan-600 to-teal-600 text-white rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200 font-medium flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed relative overflow-hidden group"
            >
  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-col items-center justify-center space-y-6">
        <div className="w-24 h-24 bg-gradient-to-br from-cyan-500 to-teal-500 rounded-full flex items-center justify-center transform transition-transform duration-300 group-hover:scale-110 group-hover:rotate-12">
          <i className="fas fa-cloud-upload-alt text-4xl text-white"></i>
        </div>

        <div className="text-center space-y-2">
          <h3 className="text-xl font-semibold text-gray-900 dark:text-white">Glissez votre fichier Excel ici</h3>
        ...
        <label className="px-8 py-3 bg-gradient-to-r from-cyan-600 to-teal-600 text-white rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200 font-medium relative overflow-hidden group/btn cursor-pointer">
          <span className="relative z-10 flex items-center gap-2">
      ...
      <table className="w-full bg-white dark:bg-gray-800">
        <thead className="bg-gradient-to-r from-cyan-600 to-teal-600 text-white">
          <tr>
            ...
            <th className="px-6 py-4 text-left text-sm font-semibold">Postnom</th>
            <th className="px-6 py-4 text-left text-sm font-semibold">Prénom</th>
        ...
        <tbody>
          {data.map((row, i) => (
            ...
            >
              <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">{i + 1}</td>
              <td className="px-6 py-4">
                <div className="flex items-center gap-2">
                  {row.photo ? (
                    ...
                    <label className="w-10 h-10 bg-gray-200 dark:bg-gray-700 rounded-full flex items-center justify-center cursor-pointer hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors duration-200">
                      <i className="fas fa-camera text-gray-500 dark:text-gray-400"></i>
                      <input
                        type="file"
                        accept="image/*"
              ...
              {["nom", "postnom", "prenom", "departement", "fonction"].map((col) => (
                <td
                  key={col}
                  className="px-6 py-4 text-sm text-gray-900 dark:text-white cursor-pointer hover:bg-cyan-50 dark:hover:bg-cyan-900/20 transition-colors duration-200"
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl p-8 max-w-md w-full mx-4">
        ...
        <h3 className="text-2xl font-bold text-center text-gray-900 dark:text-white mb-6">Génération en cours...</h3>
