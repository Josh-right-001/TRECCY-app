    ...
    >
      <div className="flex flex-col h-full">
        ...
        <button
          ...
          className="absolute -right-3 top-20 w-6 h-6 bg-cyan-600 text-white rounded-full shadow-lg hover:bg-cyan-700 transition-colors duration-200 flex items-center justify-center"
        >
